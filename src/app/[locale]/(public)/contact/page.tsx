            ...
            <div className="bg-[#07233b] grid grid-cols-1 lg:grid-cols-12 gap-8 p-6 lg:p-12 backdrop-blur-lg">
              <div className="lg:col-span-4 order-2 md:order-1 space-y-8 md:mt-42">
                ...
                <div className="flex gap-3">
                  <a target="_blank" href="https://www.facebook.com/charcrede/" className="bg-[#0762f7] text-white w-10 h-10 rounded-full px-auto flex items-center justify-center border-2 border-white">
                  ...
                  <a target="_blank" href="https://github.com/charcrede" className="bg-[#1a1e22] text-white w-10 h-10 rounded-full px-auto flex items-center justify-center border-2 border-white">
                  ...
                  <a target="_blank" href="https://www.linkedin.com/in/charcrede/" className="bg-[#007ab5] text-white w-10 h-10 rounded-full px-auto flex items-center justify-center border-2 border-white">

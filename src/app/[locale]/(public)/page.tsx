...
export default function Home() {
    ...
    return (
        <div>
            <div className="relative flex pd:mt-0 flex-col md:flex-row items-end justify-center min-h-[80vh] px-4 md:px-15 lg:px-30  bg-linear-to-r from-[#07233b] to-[#050d17]">
                <div className="md:mb-15 mt-8 md:mt-0">
                    <motion.div
                    ...
                    >
                        <Link href="/projects" className=" bg-[#0788ff] group flex py-4 justify-center items-center px-8 rounded-full w-full md:w-auto text-center uppercase">
                            {t('explore_projects')}
                ...
                >
                    <img src="/home-banner_new.png" alt="" />
                </motion.div>
            </div>
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4, ease: "easeOut" }}
                className="p-2 md:p-8 text-center italic text-white/50 bg-[#07233b]"
            >
                <p>{t('philosophy')}</p>
            </motion.div>
        </div>

            ...
            <div>
                ...
                >
                    ...
                    <div className="flex gap-4">
                        <button className="bg-[#0762f7] text-white w-12 h-12 rounded-full px-auto flex items-center justify-center border-2 border-white">
                        ...
                        <button className="bg-[#1a1e22] text-white w-12 h-12 rounded-full px-auto flex items-center justify-center border-2 border-white">
                        ...
                        <button className="bg-[#007ab5] text-white w-12 h-12 rounded-full px-auto flex items-center justify-center border-2 border-white">
